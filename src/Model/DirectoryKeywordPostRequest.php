...
/**
 * DirectoryKeywordPostRequest Class Doc Comment
 *
 * @package  EpicKitty\Ras
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DirectoryKeywordPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_directory_keyword_post_request';
    ...
    */
     ...
     * Sets categoryId
     *
     * @param int $categoryId The ID of the parent keyword category.
     *
     * @return $this
     */
