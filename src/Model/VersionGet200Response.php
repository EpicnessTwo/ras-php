...
/**
 * VersionGet200Response Class Doc Comment
 *
 * @package  EpicKitty\Ras
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VersionGet200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_version_get_200_response';
    ...
    */
     ...
     * Sets version
     *
     * @param string|null $version The release version number.
     *
     * @return $this
     */
     ...
     * Sets commit
     *
     * @param string|null $commit The latest git commit hash in this build.
     *
     * @return $this
     */
     ...
     * Sets date
     *
     * @param string|null $date The build date and timestamp in RFC3339 format.
     *
     * @return $this
     */
