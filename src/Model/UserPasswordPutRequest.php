...
/**
 * UserPasswordPutRequest Class Doc Comment
 *
 * @package  EpicKitty\Ras
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UserPasswordPutRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_user_password_put_request';
    ...
    */
     ...
     * Sets screenName
     *
     * @param string $screenName The AIM screen name or ICQ UIN of the user whose password is to be updated.
     *
     * @return $this
     */
