 ...
 */
class UserDeleteRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_user_delete_request';
    ...
    */
     ...
     * Sets screenName
     *
     * @param string|null $screenName The screen name of the user to delete.
     *
     * @return $this
     */
