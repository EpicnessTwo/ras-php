...
class UserPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_user_post_request';
    ...
    */
     ...
     * Sets screenName
     *
     * @param string $screenName The user's AIM screen name or ICQ UIN.
     *
     * @return $this
     */
     ...
     * Sets password
     *
     * @param string $password The user's password for account creation.
     *
     * @return $this
     */
